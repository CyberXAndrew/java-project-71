...
public class Differ {
    public static String generate(String filepath1, String filepath2) throws Exception { // String format
        ...
        Map<String, Object> map1 = objectMapper1.readValue(file1, new TypeReference<>(){}); //new TypeReference<Map<String,Object>>(){}
        ...
        Map<String, Object> map2 = objectMapper2.readValue(file2, new TypeReference<>(){}); //new TypeReference<Map<String,Object>>(){}
        ...
        for (String key : sortedList) {
            if (map1.containsKey(key) && map2.containsKey(key) && map1.get(key).equals(map2.get(key))) { //пары совпадут целиком
